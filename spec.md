...
The current codebase contains legacyinternal OpsPilot labels. The final branded product should use NxtBiz consistently in visible UI, documentation, package metadata, generated PDFs, console messages, seed data, and service names.
...
- POST apicustomers
- PUT apicustomersid
- DELETE apicustomersid

Emails

- POST apiemailsprocess
- GET apiemails
- GET apiemailsid
...
- POST apiinvoices
- GET apiinvoicesid
- GET apiinvoicesiddownload
- PUT apiinvoicesid
- DELETE apiinvoicesid
...
- GET apiworkflowsid
- PUT apiworkflowsid
- DELETE apiworkflowsid
- POST apiworkflowsidexecute
